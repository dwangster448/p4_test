...
main(int argc, char* argv[])
{
  ...
  1d:	68 88 08 00 00       	push   $0x888
  22:	6a 01                	push   $0x1
  24:	e8 37 05 00 00       	call   560 <printf>
    int mypid = getpid();
  29:	e8 45 04 00 00       	call   473 <getpid>
    if (getpinfo(s) == -1) {
  2e:	89 3c 24             	mov    %edi,(%esp)
    int mypid = getpid();
  31:	89 c6                	mov    %eax,%esi
    if (getpinfo(s) == -1) {
  33:	e8 63 04 00 00       	call   49b <getpinfo>
  38:	83 c4 10             	add    $0x10,%esp
  3b:	83 f8 ff             	cmp    $0xffffffff,%eax
  3e:	0f 84 10 01 00 00    	je     154 <main+0x154>
        return -1;
    }
  ...
  56:	0f 84 bf 00 00 00    	je     11b <main+0x11b>
        if (s->pid[i] == mypid)
  ...
  8d:	74 6b                	je     fa <main+0xfa>
  8f:	83 ec 0c             	sub    $0xc,%esp
  92:	6a 14                	push   $0x14
  94:	68 c8 08 00 00       	push   $0x8c8
  99:	68 98 08 00 00       	push   $0x898
  9e:	68 d1 08 00 00       	push   $0x8d1
  a3:	6a 01                	push   $0x1
  a5:	e8 b6 04 00 00       	call   560 <printf>
  aa:	83 c4 20             	add    $0x20,%esp
  ad:	6a 08                	push   $0x8
  af:	ff b4 b5 e8 f8 ff ff 	push   -0x718(%ebp,%esi,4)
  b6:	68 40 09 00 00       	push   $0x940
    ASSERT(ps.inuse[my_idx], "My slot in the ptable is not in use!");
  bb:	6a 01                	push   $0x1
  bd:	e8 9e 04 00 00       	call   560 <printf>
  c2:	5b                   	pop    %ebx
  c3:	5e                   	pop    %esi
  c4:	68 96 08 00 00       	push   $0x896
  c9:	6a 01                	push   $0x1
  cb:	e8 90 04 00 00       	call   560 <printf>
  d0:	e8 1e 03 00 00       	call   3f3 <exit>
  d5:	83 ec 0c             	sub    $0xc,%esp
  d8:	6a 12                	push   $0x12
  da:	68 c8 08 00 00       	push   $0x8c8
  df:	68 98 08 00 00       	push   $0x898
  e4:	68 d1 08 00 00       	push   $0x8d1
  e9:	6a 01                	push   $0x1
  eb:	e8 70 04 00 00       	call   560 <printf>
  f0:	83 c4 18             	add    $0x18,%esp
  f3:	68 18 09 00 00       	push   $0x918
  f8:	eb c1                	jmp    bb <main+0xbb>
    return -1;
}
...
static void test_passed() {
  ...
  fa:	51                   	push   %ecx
  fb:	68 98 08 00 00       	push   $0x898
 100:	68 a2 08 00 00       	push   $0x8a2
 105:	6a 01                	push   $0x1
 107:	e8 54 04 00 00       	call   560 <printf>
 10c:	83 c4 0c             	add    $0xc,%esp
 10f:	68 db 08 00 00       	push   $0x8db
 114:	68 e7 08 00 00       	push   $0x8e7
 119:	eb a0                	jmp    bb <main+0xbb>
    printf(1, "test_1 LINE 14\n");
 11b:	52                   	push   %edx
 11c:	52                   	push   %edx
 ...
 12f:	6a 10                	push   $0x10
 131:	68 c8 08 00 00       	push   $0x8c8
 136:	68 98 08 00 00       	push   $0x898
 13b:	68 d1 08 00 00       	push   $0x8d1
 140:	6a 01                	push   $0x1
 142:	e8 19 04 00 00       	call   560 <printf>
 147:	83 c4 18             	add    $0x18,%esp
 14a:	68 ec 08 00 00       	push   $0x8ec
 14f:	e9 67 ff ff ff       	jmp    bb <main+0xbb>
        PRINTF("getpinfo failed\n"); 
 154:	57                   	push   %edi
 155:	68 98 08 00 00       	push   $0x898
 15a:	68 a2 08 00 00       	push   $0x8a2
 15f:	6a 01                	push   $0x1
 161:	e8 fa 03 00 00       	call   560 <printf>
 166:	58                   	pop    %eax
 167:	5a                   	pop    %edx
 168:	68 a7 08 00 00       	push   $0x8a7
 16d:	6a 01                	push   $0x1
 16f:	e8 ec 03 00 00       	call   560 <printf>
 174:	59                   	pop    %ecx
 175:	5b                   	pop    %ebx
 176:	68 96 08 00 00       	push   $0x896
 17b:	6a 01                	push   $0x1
 17d:	e8 de 03 00 00       	call   560 <printf>
    printf(1, "test_1 LINE 14\n");
 182:	5e                   	pop    %esi
 183:	5f                   	pop    %edi
 184:	68 b8 08 00 00       	push   $0x8b8
 189:	6a 01                	push   $0x1
 18b:	e8 d0 03 00 00       	call   560 <printf>
 190:	83 c4 10             	add    $0x10,%esp
 193:	eb 97                	jmp    12c <main+0x12c>
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 f0 09 00 00 	movzbl 0x9f0(%edx),%edx
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d9:	ff 24 85 98 09 00 00 	jmp    *0x998(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba 8e 09 00 00       	mov    $0x98e,%edx
        while(*s != 0){
